  ...
  <li role="presentation"><a href="../userCenter/info">好友管理</a></li>
	...
	<div class="contentPanel">
		...
		<ul class="nav nav-tabs">
		  <li role="presentation" class="active"><a href="#">粉丝</a></li>
		  <li role="presentation"><a href="#">关注</a></li>
		</ul>
		<ul class="nav nav-pills">
		  <li id="desc" role="presentation" onclick="window.location.href = '/userCenter/myFan?asc=0&page=0'"
		  <?=!$asc?"class='active'": ""?>><a href="#">最近关注</a></li>
		  <li id="asc" role="presentation"  onclick="window.location.href = '/userCenter/myFan?asc=1&page=0'"
		...
		@include('nav', array('currentPage' => Request::get('page'), 'itemCount' => count($users), 
				'pageUrl' => '../userCenter/myFan?asc='.{{$asc}}.'&page='))
		@else
			hehe，没有数据
		@endif
	</div>
